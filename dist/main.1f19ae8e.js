...
function (_EventBus) {
  ...
  function View(options) {
    ...
    //继承类, 需要调用父类初始化
    _this = _possibleConstructorReturn(this, _getPrototypeOf(View).call(this)); //options上有什么都放在this上面
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(data) {
      ...
      (0, _jquery.default)(this.html.replace("{{n}}", n)).appendTo((0, _jquery.default)(this.el));
    },
    events: {
      "click #add1": "add",
      "click #subtract": "sub",
...
var localKey = "app2.index"; // 数据相关: m
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(data) {
      ...
      (0, _jquery.default)(this.html(index)).appendTo((0, _jquery.default)(this.el));
    },
    events: {
      "click .tab-bar li": "x"
    },
